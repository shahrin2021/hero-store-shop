...
div.innerHTML=`
<div><img class="image-details" src="${data.image}" alt="img">
  ...
  const showProducts = (products) => {
    ...
    for (const product of allProducts) {
      ...
      <img class="product-image" src=${product.image}></img>
        ...
        <button onclick="showProductsDetails(${product.id})" id="details-btn" class="btn btn-danger">Details</button></div>
        
        </div>
        `;
      document.getElementById("all-products").appendChild(div);
      // showProductsDetails(product.id);
    }
